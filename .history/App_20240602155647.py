...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.create_dial_labels(self.dial, self.dialLayout, [ "10", "20", "30", "40", "50", "60"])
        self.create_dial_labels(self.dial_2, self.dialLayout, ["10", "20", "30", "40", "50", "60"])
    ...
    def create_dial_labels(self, dial, layout, labels):
        positions = [
            (0.5, 0), (0.75, 0.25), (1, 0.5), (0.75, 0.75), (0.5, 1), (0.25, 0.75), (0, 0.5)
        ]
        ...
        for pos, label in zip(positions, labels):
            ...
            lbl.setParent(dial)
            lbl.move(int(dial.width() * pos[0] - lbl.width() / 2), int(dial.height() * pos[1] - lbl.height() / 2))
            lbl.show()
