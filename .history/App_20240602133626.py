...
class MainWindow(QMainWindow):
    ...
    def on_dial_valueChanged(self, value):
        ...
        adjusted_value_1 = round(value / step_1) * step_1
        self.dial.setValue(adjusted_value_1)
        self.label_tuner.setText(f"Current Value: {adjusted_value_1}")

    def on_dial_2_valueChanged(self, value):
            # Adjust value to nearest step
        step_2 = self.dial_2.singleStep()
        adjusted_value_2 = round(value / step_2) * step_2
        self.dial_2.setValue(adjusted_value_2)
        self.label_connection.setText(f"Current Value: {adjusted_value_2}")
