...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.create_dial_labels(self.dial, [ "Clean", "Fuzz", "Tremelo", "Overdrive", "Delay", "Chorus"])
        self.create_dial_labels(self.dial_2,  [ "Clean", "Fuzz", "Tremelo", "Overdrive", "Delay", "Chorus"])
    ...
    def create_dial_labels(self, dial, labels):
        radius = dial.width() // 2
        center_x = dial.x() + radius + dial.parentWidget().x()
        center_y = dial.y() + radius + dial.parentWidget().y()
        ...
        for i, label in enumerate(labels):
            ...
            x = center_x + (radius + 30) * math.cos(radians) - 15
            y = center_y + (radius + 30) * math.sin(radians) - 15
