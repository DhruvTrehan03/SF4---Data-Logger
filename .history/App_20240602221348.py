...
class MainWindow(QMainWindow):
    ...
    def on_pushButton_clicked(self):
        ...
        adjusted_value_1 = round(self.dial.value / step_1) * step_1
        self.dial.setValue(adjusted_value_1)

        step_2 = self.dial_2.singleStep()
        adjusted_value_2 = round(self.dial.value / step_2) * step_2
        self.dial_2.setValue(adjusted_value_2)
        
        # Placeholder slot for button click
        print(adjusted_value_1, ", ", adjusted_value_2)
